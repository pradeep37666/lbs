...
const stripe = loadStripe(
	'pk_test_51JAi4wAaysFIruTL4KcRCjRZ1aSi6KYbnBDjGRkKuuht6nojLH2ItABIh430Ee9nHzbnqgm80dlwWJZfXMLrbATw00fg4d8m5c'
)
		...
		return (
			<Route
				...
				render={(props) =>
					user ? (
						<Redirect
							to={{ pathname: '/user/account', state: { from: props.location } }}
						/>
					) : (
						<Component {...props} />
					)
