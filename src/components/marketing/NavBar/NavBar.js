  ...
  return (
    <div className='nav_bar_container'>
      <div className='register_bar_container'>
        <p className='register_title' onClick={() => history.push('/register')}>
          Sign Up
        </p>
        <p className='register_title' onClick={() => history.push('/login')}>
          Login
        </p>
      </div>
      <div className='nav_bar_box'>
        <div className='nav_bar_left'>
          <Link to='/'>
            <img src={Logo} className='nav_bar_logo' />
          </Link>
          <div className='link_title_box'>
            <Link
              to='/lend_your_stuff'
              className={
                selected === 'lend_your_stuff'
                  ? 'link_title selected'
                  : 'link_title'
              }
            >
            ...
            <Link
              to='/rent_stuff'
              className={
                selected === 'rent_stuff' ? 'link_title selected' : 'link_title'
              }
            >
              Rent Stuff
            </Link>
            ...
            <Link
              to='/about_us'
              className={
                selected === 'about_us' ? 'link_title selected' : 'link_title'
              }
            >
              About Us
            </Link>
            ...
            >
              ...
              <div
                className={isInfoOpen ? 'nav_popup_opend' : 'nav_popup_closed'}
              >
                <p
