    ...
    return (
        <div className="RegistrationWrapper">
            <div className="LoginMain">
                ...
                <div className="LoginText">Please provide us with as many photos you can of your item. Your first image will be used as your main product image. Recommended image size is at least 300 x 300 pixels.</div>
