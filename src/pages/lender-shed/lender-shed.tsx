...
function LenderShed() {
    ...
    const renderLenderReviews = () => {
        return lenderReviews.map((review, index) => {
            return <ReviewCard review={review} isOnlyOne={lenderReviews.length > 1 ? false : true} key={index} />
        })
    }
    ...
    if (isLoading) return <PageWrapper>
                <main id='Lender Shed' className='py-[5%] w-full px-[15%] flex justify-center items-center'>
            ...
            <main id='Lender Shed' className='py-[5%] w-full px-[15%]'>
                <section className='grid grid-cols-[1fr_3fr] gap-8 w-full'>
                    ...
                    <section>
                        ...
                        <Button onClick={() => null} text={`Message ${lender.firstName}`} className='bg-white text-black-base hover:bg-white mb-4'/>
                    ...
                    <section>
                        <h1 className='font-bold text-[35px] text-blue-base mb-4'>{lender.firstName}'s Shed</h1>

                        <section className='flex-wrap flex gap-4'>
                            {renderLenderItems()}
                        </section>
