  ...
  return (
    <div className='marketing_container'>
      ...
      <div className='marketing_img_flexible_container bg_grey flex_box center_items straight_column'>
        <p
          className='contact_detail_title'
          style={{ maxWidth: '70%', padding: '0', paddingTop: '4rem' }}
        >
          We’re here to help! If you haven’t found what you’re looking for in
          our Guides and FAQs or Blog feel free to fill out the form below with
          your query and we’ll get back to you soon.
        </p>
      </div>
        ...
        <div className='contact_input_container'>
          <div className='contact_input_box'>
              ...
              <div className='input_fields_right'>
                ...
                <div className='news_letter_box pt-3'>
                  <div className='news_title_box'>
                    <p className='news_main_title'>Subscribe To News Letters</p>
            ...
            <div className='submit_btn_container'>
              <button className='submit_message_btn' onClick={handleSubmit}>
                Send Message
              </button>
            </div>
          </div>
          <div className='contact_details_box'>
            <div className='contact_number_box'>
              <p className='contact_detail_title'>Call Our Help Line</p>
              <p className='contact_detail_content'>0800 1234</p>
            </div>
            <div className='contact_email_box'>
              <p className='contact_detail_title'>Email Our Support Center</p>
